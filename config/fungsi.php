...
function tampilpendidikan($id){
	...
	$cek=mysqli_fetch_array($result);
	$_SESSION['statuspendidikan']=$cek['status'];
...
function daftarformulir($nama_lengkap,$tempat_lahir,$tgl_lahir,$jenis_kelamin,$agama,$no_hp,$alamat,$provinsi,$no_jaket,$email,$tgl_daftar){
	global $konek;

	$sql="INSERT INTO `formulir_mhs`(`nama_lengkap`, `tempat_lahir`, `tgl_lahir`, `jenis_kelamin`, `agama`, `no_hp`, `alamat`, `provinsi`, `no_jaket`, `email`, `tgl_daftar`) VALUES ('$nama_lengkap','$tempat_lahir','$tgl_lahir','$jenis_kelamin','$agama','$no_hp','$alamat','$provinsi','$no_jaket','$email','$tgl_daftar')";
